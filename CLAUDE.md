...
A single-page dermatology practice website for Dr. Yashasve at Suseela Hospital, SRK Puram, Kothapet, LB Nagar, Hyderabad. Built with React 19, TypeScript, Vite, and Tailwind CSS (loaded via CDN). Uses Framer Motion for animations and Lucide React for icons.
